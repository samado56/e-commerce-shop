...
export default function DeleteOrderModal({ closeModal, showModal }) {
          ...
          >
            <div className="flex flex-col items-center justify-center gap-2 text-center">
              ...
              <h1 className="text-2xl font-bold ">
                Are you sure you wnat to delete Order #12345?
              </h1>
              <p className="text-gray-500 text-md">
                This action cannot be undone. All related data will be
                permanently removed.
              </p>
              <ul className="p-4 mt-4 rounded-md bg-gray-400/10 border-2 border-gray-400/20  w-full">
                <li className=" text-gray-600 font-medium flex items-center justify-between mb-1">
                  <span>Customer:</span>
                  <span className="block font-[400]">Sophia Clark</span>
                </li>
                <li className="text-gray-600  font-medium flex items-center justify-between mb-1">
                  <span>Total:</span>
                  <span className="block font-[400]">$150.00</span>
                </li>
                <li className="text-gray-600 font-medium flex items-center justify-between">
                  <span>Status:</span>
                  <Label label="Deliverd" className="label-green-start" />
                </li>
              </ul>
            </div>
